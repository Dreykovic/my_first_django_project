...
Pour se faire j'ai modifier ma fonction \textbf{generate\_pdf()} comme suit:
	...
	Et voici le rendu :
	\begin{center}
		\includegraphics[scale=0.4]{images/notesnav.png}
	\end{center}
\item Créons la vue  \textbf{notesSynthese} permettant de générer pour chaque élève sa moyenne dans chaque matiere
